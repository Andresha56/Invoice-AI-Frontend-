...
export class InvoiceEngine {
   ...
   */
  public checkMissingDetails(entities: ExtractedEntities): MissingFieldInfo[] {
  ...
  public assembleInvoice(
    ...
    return {
      ...
      taxTotal,
      grandTotal,
      amountInWords: this.numberToWords(grandTotal, entities.currency || "INR"),
      addons,
