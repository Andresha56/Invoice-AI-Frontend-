...
import type { BusinessProfile, ClientRecord } from "../types.js";
 ...
 */
export function matchClient(query?: string): {
  client: ClientRecord;
  isMatched: boolean;
  ...
  const sanitizedEmail = formattedName.toLowerCase().replace(/[^a-z0-9]/g, "");
